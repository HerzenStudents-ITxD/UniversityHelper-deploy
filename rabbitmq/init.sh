...
for i in "UniversityHelper.UserService","1234" "UniversityHelper.RightsService","1234" "UniversityHelper.CommunityService","1234" "UniversityHelper.AuthService","1234" "UniversityHelper.FeedbackService","1234"; do 
    IFS=","; 
    set -- $i; 
    # echo $1 and $2; 
    RABBITMQ_USER=$1
